...
class JFormFieldDescription extends JFormField {
	...
	{		
		...
		switch ($extension_name):
			...
			case "contactinfo":
				$extension_type = 'Module';
				$view_demo_link = 'https://demo.web357.eu/joomla/contact-info';
				$more_details_link = 'https://www.web357.eu/joomla-extensions/contact-info';
				$doc_link = 'https://www.web357.eu/support/documentation/contact-info';
				$changelog_link = $more_details_link.'#changelog';
				$support_link = $more_details_link.'#support';
				$more_description = '';
				$jed_link = '';
