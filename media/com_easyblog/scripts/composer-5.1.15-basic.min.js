...
c.after(b.createNestedDropzone())})),"content"==d){var e=g.nestable.availablePositions(c);a.each(e,function(a,d){c.prepend(b.createNestedDropzone(d))})}});var c=g.getRootBlocks();c.each(function(c){var d=a(this);0==c&&d.before(b.createDropzone()),d.hasClass("is-sort-item")||d.after(b.createDropzone())}),c.length<1&&b.root().append(b.createDropzone()),b.dropzone().droppable(b.droppableOptions)},createDropzone:function(){return a(b.dropzonePlaceholder).clone()},createNestedDropzone:function(a){var c=b.createDropzone().addClass("is-nested");
return a&&c.addClass("nest-"+a).data("position",a),c},destroyDropzones:function(){b.dropzone().remove()},"{block} dragstart":function(a,c,d){c.stopPropagation(),d.helper.addClass("is-helper").css({width:a.width(),height:a.height()}),g.deactivateBlock(),g.drag(a),a.addClass("hide"),h=a,b.populateDropzones(),f.manager().addClass("is-resizing")},"{blocks.menu} dragstart":function(a){b.populateDropzones(),h=a,f.manager().addClass("is-resizing")},"{mediaFile} dragstart":function(){b.populateDropzones(),h=a(),f.manager().addClass("is-resizing")
},"{dropzone} click":function(a){if(!f.manager().hasClass("is-dragging-block")){b.isDropping=!0;var d=b.selectedBlock;d.removeClass("hide").removeClass("is-sort-item"),b.dropBlock(a,d),setTimeout(function(){b.isDropping=!1,b.dropStop(),b.selectedMenu=null,b.selectedBlock=null,f.manager().removeClass("is-dropping-block"),f.manager().removeClass("is-moving-block")},0)}},"{dropzone} mouseenter":function(a){a.addClass("is-receiving")},"{dropzone} mouseleave":function(a){a.removeClass("is-receiving")},"{dropzone} dropover":function(a,c,d){g.over(a),b.lastDropzone=a;
var e=a.data("position");d.helper.addClass("is-sending"),e&&b.nest.of(a).data("snappedPosition",e)},"{dropzone} dropout":function(a,c,d){b.lastDropzone=null,g.out(a),d.helper.removeClass("is-sending")},isDropping:!1,lastDropzone:null,dropBlock:function(a,d){var e=d,h=d.is(g.menu);h&&(e=g.createBlockFromMenu(d));var i=d.is(b.mediaFile);i&&(e=g.createBlockFromMediaFile(d));var j=f.manager().hasClass("is-moving-block"),k=f.manager().hasClass("is-dropping-block"),l=f.manager().hasClass("is-duplicating-block");if(j||k){var m=g.getBlockNest(a),n=a.data("position");
m.data("snappedPosition",n)}var o=a.hasClass(c);return a.replaceWith(e),(h||i||j||k||l)&&(g.drop(e),g.release(e),g.out(e),o&&e.addClass(c)),e},dropStop:function(){setTimeout(function(){b.destroyDropzones()},1),f.manager().removeClass("is-resizing")},"{dropzone} drop":function(a,d,e){if(!b.isDropping){b.isDropping=!0;var f=e.draggable,g=a.hasClass(c);block=b.dropBlock(a,f),setTimeout(function(){b.isDropping=!1,g&&block.addClass(c)},0)}},"{block} dragstop":function(a){a.removeClass("hide"),g.drop(a),g.release(a),g.out(a),b.dropStop()
},"{blocks.menu} dragstop":function(a,c,d){if(b.isDropping||!b.lastDropzone)return b.dropStop(),void 0;var e=d.helper;b.dropBlock(b.lastDropzone,e),b.dropStop()},"{mediaFile} dragstop":function(a,c,d){if(b.isDropping||!b.lastDropzone)return b.dropStop(),void 0;var e=d.helper;b.dropBlock(b.lastDropzone,e),b.dropStop()},"{self} composerDocumentScroll":function(b,c){var d=h.data("ui-draggable");a.ui.ddmanager.prepareOffsets(d,c)},"{dropzone} dropdeactivate":function(a){g.out(a)}}}),b.resolve()})}),EasyBlog.module("composer/blocks/font",function(a){var b=this;
...
},"{updatePost} click":function(a){b.publishedField().val()==e&&(b.previewField().val(0),b.publishedField().val(g)),b.disableLeavePrompt(),a.addClass("is-loading"),b.save()},"{unpublishPostButton} click":function(){b.publishedField().val(i),b.save({autosave:0,isapply:0})},"{trashPost} click":function(){b.trash()},"{draftDiscard} click":function(){EasyBlog.ajax("site/views/composer/discardDraft",{id:b.getPostId()}).done(function(a){b.setMessage({type:"success",message:a}),j.removeClass("warning-draft"),b.draftItems().remove()
