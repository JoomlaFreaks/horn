							...
							<?php if ($option->title && $option->value) { ?>
								<div class="mt-10">
									<div class="eb-checkbox<?php echo ($limit && $i >= $limit) ? ' hide' : '';?>" <?php echo ($limit && $i >= $limit) ? 'data-item-hide' : '';?>>
										<input type="checkbox" id="<?php echo $option->value;?>" name="field-<?php echo $field->id;?>[]" value="<?php echo $option->value;?>" <?php echo $option->checked ? 'checked' : ''; ?> data-checkbox-option/>
