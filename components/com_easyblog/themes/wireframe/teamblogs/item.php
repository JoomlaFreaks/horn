	...
	<div class="eb-author eb-author-teamblog" data-team-item data-id="<?php echo $team->id;?>">
		<div class="eb-authors-head row-table">
			...
			<div class="col-cell cell-tight">
				<a class="eb-avatar pull-left" href="<?php echo $team->getPermalink();?>">
					<img src="<?php echo $team->getAvatar(); ?>" class="eb-authors-avatar" width="100" height="100" alt="<?php echo $team->getTitle();?>" />
				</a>
			</div>
			<?php } ?>
		...
		<div class="eb-authors-bio">
			...
			<div class="eb-authors-subscribe spans-seperator">
				...
				<span>
					<a class="link-subscribe <?php echo $isTeamSubscribed ? 'hide' : ''; ?>" href="javascript:void(0);" data-blog-subscribe data-type="team" data-id="<?php echo $team->id; ?>" title="<?php echo JText::_('COM_EASYBLOG_SUBSCRIBE_TEAM'); ?>">
						<?php echo JText::_('COM_EASYBLOG_SUBSCRIBE_TEAM'); ?>
					</a>
					<a class="link-subscribe <?php echo $isTeamSubscribed ? '' : 'hide' ?>" href="javascript:void(0);" data-blog-unsubscribe data-type="team" data-id="<?php echo $team->id; ?>" data-email="<?php echo $this->my->email; ?>"><?php echo JText::_('COM_EASYBLOG_UNSUBSCRIBE_TEAM');?></a>
				</span>
				<?php } ?>
