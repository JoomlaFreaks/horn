			...
			<div class="eb-author <?php echo $this->isMobile() ? 'is-mobile' : '';?>" data-team-item data-id="<?php echo $team->id;?>">
				...
				<div class="eb-authors-bio">
					...
					<div class="eb-authors-subscribe spans-seperator">
						...
						<span>
							<a href="javascript:void(0);" class="<?php echo $team->isTeamSubscribed ? 'hide' : ''; ?>" data-blog-subscribe data-type="team" data-id="<?php echo $team->id; ?>"><?php echo JText::_('COM_EASYBLOG_SUBSCRIBE_TEAM');?></a>
							<a href="javascript:void(0);" class="<?php echo $team->isTeamSubscribed ? '' : 'hide'; ?>" data-blog-unsubscribe data-subscription-id="<?php echo $team->subscription_id; ?>"><?php echo JText::_('COM_EASYBLOG_UNSUBSCRIBE_TEAM');?></a>
						</span>
						<?php } ?>
