	...
	<div class="col-cell">
		...
		<div class="eb-revision-options btn-toolbar">
			...
			<div class="btn-group btn-group-xs">
				...
				<a href="<?php echo EBR::_('index.php?option=com_easyblog&view=entry&layout=preview&uid=' . $post->id . '.' . $revision->id . '&preview=1');?>" class="btn btn-eb-default-o btn--xs" target="_blank">
