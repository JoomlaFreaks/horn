		...
		<div data-scrolly-viewport>
			<div class="eb-composer-fieldset">
				...
				<div class="eb-composer-fieldset-content o-form-horizontal">
					<input class="o-form-control input-sm" type="text" id="custom_title" name="custom_title" value="<?php echo $this->html('string.escape', $post->custom_title);?>"
			...
			<div class="eb-composer-fieldset">
				...
				<div class="eb-composer-fieldset-content o-form-horizontal">
					<select name="robots" id="robots" class="o-form-control input-sm">
