...
?>
<?php
	if (($this->config->get('integrations_facebook_centralized_and_own') && $user->hasOauth('facebook') && $this->config->get('integrations_facebook')) ||
		($this->config->get('integrations_twitter_centralized_and_own') && $user->hasOauth('twitter') && $this->config->get('integrations_twitter')) ||
		...
		<div class="o-form-group">
			<div class="o-control-input">
				<div class="eb-comp-autopost">
					...
					<?php if ($this->config->get('integrations_facebook') && $this->config->get('integrations_facebook_centralized_and_own') && $user->hasOauth('facebook')) { ?>
					<div class="o-checkbox o-checkbox--inline t-lg-mr--lg">
						<input type="checkbox" name="autoposting[]" id="autopost-facebook" value="facebook" data-autopost-facebook
							<?php if ($user->getOauth('facebook')->isShared($post->id)) { ?>
							disabled="disabled"
							<?php } else { ?>
								<?php echo $user->getOauth('facebook')->auto ? ' checked' : '';?>
							<?php } ?>
						/>
						<label for="autopost-facebook"
