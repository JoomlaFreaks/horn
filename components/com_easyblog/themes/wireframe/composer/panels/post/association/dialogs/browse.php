...
<dialog>
	...
	<content><?php echo JURI::root();?>index.php?option=com_easyblog&view=composer&layout=getPosts&code=<?php echo $code;?>&codeid=<?php echo $id;?>&tmpl=component&browse=1</content>
	<buttons>
