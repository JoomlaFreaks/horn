				...
				<div class="eb-category-subscribe spans-seperator">
					...
					<?php if ((($category->private && $this->my->id != 0) || ($this->my->id == 0 && $this->config->get('main_allowguestsubscribe')) || !$this->my->guest) && $this->config->get('main_categorysubscription') && $this->params->get('category_subscriptions', true)) { ?>
						<span class="eb-category-subscription">
							<a href="javascript:void(0);" class="link-subscribe <?php echo $category->isCategorySubscribed ? 'hide' : ''; ?>" data-blog-subscribe data-type="category" data-id="<?php echo $category->id;?>">
								<?php echo JText::_('COM_EASYBLOG_SUBSCRIPTION_SUBSCRIBE_CATEGORY'); ?>
							</a>
							<a href="javascript:void(0);" class="link-subscribe <?php echo $category->isCategorySubscribed ? '' : 'hide'; ?>" data-blog-unsubscribe data-subscription-id="<?php echo $category->subscriptionId;?>" data-return="<?php echo base64_encode(JRequest::getURI());?>">
