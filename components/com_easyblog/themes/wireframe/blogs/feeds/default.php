...
<head>
	...
	<meta property="fb:use_automatic_ad_placement" content="enable=true ad_density=<?php echo $config->get('fb_ads_density', 'default'); ?>">
	<?php } ?>
</head>
<body>
<article>
	...
	<?php if ($config->get('googleAnalyticsCode', false)) { ?>
	<figure class="op-tracker">
		<iframe>
			...
			ga('create', '<?php echo $config->get('googleAnalyticsCode', false); ?>', 'auto');
			ga('send', 'pageview');
			</script>
		</iframe>
	</figure>
