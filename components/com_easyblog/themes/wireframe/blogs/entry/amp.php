...
<html amp lang="<?php echo $langTag; ?>" <?php echo $isRtl ? 'dir="rtl"' : ''; ?>>
	<head>
		...
		<?php if (in_array('youtube', $availableBlocks)) { ?>
		...
		<div class="blog-content">
			...
			<?php if ($this->params->get('post_social_buttons', true)) { ?>
				<div class="blog-social">
					...
					<amp-social-share type="whatsapp" data-share-endpoint="whatsapp://send" data-param-text="<?php echo JText::sprintf('COM_EASYBLOG_AMP_WHATSAPP_SHARE', addslashes($post->getTitle())); ?>" width="45" height="33"></amp-social-share>
				</div>
			<?php } ?>
		</div>
