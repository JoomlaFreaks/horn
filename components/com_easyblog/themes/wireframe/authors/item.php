	...
	<div class="eb-authors-head row-table">
		...
		<div class="col-cell">
			...
			<div class="eb-authors-subscribe">
				...
				<span>
					<a class="<?php echo $isBloggerSubscribed ? 'hide' : ''; ?>" href="javascript:void(0);" data-blog-subscribe data-type="blogger" data-id="<?php echo $author->id;?>"><?php echo JText::_('COM_EASYBLOG_SUBSCRIPTION_SUBSCRIBE_TO_BLOGGER');?></a>
					<a class="<?php echo $isBloggerSubscribed ? '' : 'hide'; ?>" href="javascript:void(0);" data-blog-unsubscribe data-type="blogger" data-id="<?php echo $author->id;?>" data-email="<?php echo $this->my->email; ?>"><?php echo JText::_('COM_EASYBLOG_SUBSCRIPTION_UNSUBSCRIBE_TO_BLOGGER');?></a>
				</span>
				<?php } ?>
