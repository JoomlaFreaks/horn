...
<div class="eb-subscription">
	...
	<div class="eb-subscribe row-table cell-top">
		...
		<div class="col-cell cell-ellipse eb-subscribe-details">
			...
			<a href="javascript:void(0);" class="btn btn-sm btn-default" data-blog-unsubscribe data-subscription-id="<?php echo $subscriptions['site'][0]->id;?>" data-return="<?php echo base64_encode(JRequest::getUri());?>">
	...
	<?php foreach ($groups as $group) { ?>
		...
		<div class="eb-subscribe row-table cell-top">
			...
			<div class="col-cell eb-subscribe-thumb cell-tight">
				<a href="<?php echo $subscription->object->objPermalink;?>" class="eb-avatar" class="eb-avatar">
					<?php if ($group == 'category') { ?>
						<img src="<?php echo $subscription->object->objAvatar;?>" width="60" height="60" alt="<?php echo $subscription->object->title;?>" />
					<?php } ?>

					<?php if ($group == 'blogger') { ?>
						<img src="<?php echo $subscription->object->objAvatar;?>" class="eb-authors-avatar" width="60" height="60" alt="<?php echo $subscription->object->title;?>" />
					<?php } ?>
				</a>
			</div>
			<?php } else { ?>
			...
			<div class="col-cell cell-ellipse eb-subscribe-details">
				...
				<a href="javascript:void(0);" class="btn btn-sm btn-default" data-blog-unsubscribe data-subscription-id="<?php echo $subscription->id;?>" data-return="<?php echo base64_encode(JRequest::getUri());?>">
					<?php echo JText::_('COM_EASYBLOG_UNSUBSCRIBE');?>
				</a>
			</div>
		</div>
