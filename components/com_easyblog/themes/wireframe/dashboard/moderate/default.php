		...
		<div class="eb-dashboard-sticky-header" data-eb-spy="affix" data-offset-top="240">
			<div class="eb-dashboard-entry-header">
				...
				<div class="eb-table-filter row ml-0 mr-0">
					<div class="col-xs-12 col-lg-4 hide" data-eb-form-actions>
						<div class="eb-filter-select-group mr-5">
						...
						<a class="btn btn-default pull-left" href="javascript:void(0);" data-eb-form-apply>
	...
	<table class="eb-table table table-striped table-hover">
		...
		<tbody>
			...
			<tr data-eb-post-item data-id="<?php echo $post->id;?>">
				...
				<td>
					...
					<div class="post-meta">
						...
						<ul class="post-actions" data-eb-actions data-id="<?php echo $post->getUid();?>">
							<li>
								<a href="<?php echo $post->getEditLink(); ?>"><?php echo JText::_('COM_EASYBLOG_DASHBOARD_PENDING_REVIEW_POST'); ?></a>
							</li>
				...
				<td class="text-center">
					<?php echo $post->getCreationDate()->format(JText::_('DATE_FORMAT_LC5'));?>
				</td>
			</tr>
			<?php } ?>
		</tbody>
