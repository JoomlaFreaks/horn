		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group <?php echo $this->config->get('custom_email_logo') ? '' : 'hide'; ?>" data-email-logo-wrapper>
					<?php echo $this->html('panel.label', 'COM_EASYBLOG_SETTINGS_NOTIFICATIONS_CUSTOM_EMAILS_LOGO'); ?>

					<div class="col-md-7" data-email-logo data-id="" data-default-email-logo="<?php echo EB::notification()->getLogo(true); ?>">
						<div class="mb-20">
							<div class="eb-img-holder">
								<div class="eb-img-holder__remove" data-email-logo-restore-default-wrap <?php echo EB::notification()->hasOverrideLogo() ? '' : 'style="display: none;'; ?>>
								...
								<img src="<?php echo EB::notification()->getLogo(); ?>" width="200" data-email-logo-image />
							</div>
