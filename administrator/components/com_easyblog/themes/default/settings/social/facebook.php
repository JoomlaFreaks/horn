	...
	<div class="col-lg-6">
		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<?php echo $this->html('form.label', 'COM_EASYBLOG_GOOGLE_ANALYTICS_CODE', 'googleAnalyticsCode'); ?>

					<div class="col-md-7">
						<div class="input-group input-group-link">
							<input type="text" name="googleAnalyticsCode" id="googleAnalyticsCode" class="form-control" value="<?php echo $this->config->get('googleAnalyticsCode');?>" />
							<span class="input-group-btn">
								<a href="https://support.google.com/analytics/answer/1008015?hl=en&ref_topic=3544906" target="_blank" class="btn btn-default">
									<i class="fa fa-life-ring"></i>
								</a>
							</span>
						</div>
