	...
	<div class="col-lg-6">
		<div class="panel">
			...
			<div class="panel-body">
				...
				<?php echo $this->html('settings.text', 'main_remotepublishing_mailbox_port', 'COM_EASYBLOG_SETTINGS_WORKFLOW_REMOTE_PUBLISHING_MAILBOX_PORT', '', array('attributes' => 'data-mailbox-port', 'size' => '3'), '', 'text-center'); ?>
				...
				<?php echo $this->html('settings.text', 'main_remotepublishing_mailbox_mailboxname', 'COM_EASYBLOG_SETTINGS_WORKFLOW_REMOTE_PUBLISHING_MAILBOX_MAILBOX_NAME', '', array('attributes' => 'data-mailbox-name', 'size' => '3'), '', 'text-center'); ?>
