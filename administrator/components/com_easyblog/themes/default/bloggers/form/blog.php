...
<div class="row">
	...
	<div class="col-lg-6">
		<div class="panel">
			<?php echo $this->html('panel.heading', 'COM_EASYBLOG_BLOGGERS_FORM_SOCIAL_FACEBOOK', 'COM_EASYBLOG_BLOGGERS_FORM_SOCIAL_FACEBOOK_INFO'); ?>

			<div class="panel-body">
				<div class="form-group">
					<?php echo $this->html('form.label', 'COM_EASYBLOG_OAUTH_ALLOW_ACCESS', 'access'); ?>
				...
				<div class="form-group">
					<?php echo $this->html('form.label', 'COM_EASYBLOG_OAUTH_ENABLE_AUTO_UPDATES', 'integrations_facebook_auto'); ?>
