...
?>
<input class="form-control app-filter-bar__search-input" name="search" value="<?php echo $this->escape($value);?>" placeholder="<?php echo JText::_('COM_EASYBLOG_SEARCH', true );?>" data-table-grid-search-input="" type="text">
