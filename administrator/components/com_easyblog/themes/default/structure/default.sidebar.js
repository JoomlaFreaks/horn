EasyBlog.ready(function($){
	...
	$.ajax({
		...
		success: function(data) {
			...
			if (data.error) {
				$('#eb.eb-admin').prepend('<div style="margin-bottom: 0;" class="app-alert is-on alert alert-danger"><div class="row-table"><div class="col-cell cell-tight"><i class="fa fa-bolt"></i></div><div class="col-cell alert-message pl-10 pr-10">' + data.error + '</div></div></div>');
			}
