...
class EasyBlogNotification extends EasyBlog
{
	...
	public function sendSubscribers($emailTitle, $template, $data, EasyBlogPost $post, $ignoreEmails = array())
	{
		...
		if ($customNotifications && $aclNotification) {
	...
	{
		$logo = rtrim(JURI::root(), '/') . '/media/com_easyblog/images/email/' . $this->logoName;
	...
	public function getOverridePath()
	{
		...
		$path = '/templates/' . $defaultJoomlaTemplate . '/html/com_easyblog/emails/' . $this->logoName;
