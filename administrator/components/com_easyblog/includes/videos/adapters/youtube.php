...
class EasyBlogVideoYoutube extends EasyBlogVideoProvider
{
	...
	public function getEmbedHTML($url, $width = null, $height = null)
	{
		...
		return '<div class="legacy-video-container"><iframe title="YouTube video player" ' . $width . $height . ' src="' . $url . '&wmode=transparent" frameborder="0" allowfullscreen></iframe></div>';
	}
}
